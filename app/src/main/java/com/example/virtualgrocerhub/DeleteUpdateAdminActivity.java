...
public class DeleteUpdateAdminActivity extends Activity
{
    ListView lvGrocery;
    List<Grocery> gc;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_delete_update_admin);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot)
            {
                ...
                if(!gc.isEmpty())
                {
                    try
                    {
                        DeleteUpdateAdapter duad = new DeleteUpdateAdapter(DeleteUpdateAdminActivity.this,R.layout.delete_update_grocery,gc);
                        lvGrocery.setAdapter(duad);
                    }
                    catch (Exception e)
                    {
